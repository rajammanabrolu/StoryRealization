...
class MonteCarloTreeNode(object):
    ...
    def evaluate(self, references, hypotheses, weights = [0.25,0.25,0.25,0.25,0.25]):
        ...
        weights = np.load("/media/twister/04dc1255-e775-4227-9673-cea8d37872c7/ASTER/Event2Sentence/5-weights.npy")
...
class MonteCarlo(object):
	...
	num_playouts = 3
        ...
        bestScores = self.tt.FloatTensor([MCNode.playout(num_playouts, [dec_states[0][:,i:i+1,:],dec_states[1][:,i:i+1,:]], context[:,i:i+1,:], self.rev_vocab, self.eos) for i, MCNode in enumerate(MCNodes)])
    ...
    def reweight(self, event, generated):
        decay = 0.99
        old_weight = np.load("/media/twister/04dc1255-e775-4227-9673-cea8d37872c7/ASTER/Event2Sentence/5-weights.npy")
	...
	np.save("/media/twister/04dc1255-e775-4227-9673-cea8d37872c7/ASTER/Event2Sentence/5-weights.npy", new_weight)
