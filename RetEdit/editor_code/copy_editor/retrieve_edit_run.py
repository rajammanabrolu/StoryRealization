...
class RetrieveEditTrainingRun(TorchTrainingRun):
    ...
    def _compute_metrics(cls, editor, examples, num_evaluate_examples, batch_size):
        ...
        for batch in verboserate(chunks(sample, batch_size), desc='Computing loss on examples'):
            ...
            #loss_val = loss_var.data[0].item()
            #print loss_val.__dict__
            # print loss_var.data[0].double()
            # print type(loss_var.data[0].double())
            # print ('aowiefhoaweifhaweiofh')
            # print (loss_var)
            # print loss_var.data
            # print loss_var.data[0]
            # print loss_var.item()
            # print ('aowiefhoaweifhaweiofh')
