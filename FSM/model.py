...
#TODO Implement Xavier initialization using relu gain
#DONE Fix tensor mismatch on multi-layer decoder back-prop
...
class Seq2Seq(nn.Module):
    ...
    def forward(self, input_src, input_trg, ctx_mask=None, trg_mask=None):
        """Propogate input through the network."""
        #print "============================"
        #print input_src, input_trg, ctx_mask, trg_mask
